...
export default function NotificationsScreen() {
  ...
  const handleNotificationPress = async (notification: Notification) => {
    ...
    if (notification.type === "system") {
      ...
      navigation.navigate("Chat", { chatId: notification.url })
    } else if (notification.type === "delivery") {
      navigation.navigate("Delivery", {
        screen: "RideSummary",
        params: { deliveryId: notification.url },
      })
    }
  }
  ...
  const renderNotificationItem = (notification: Notification) => (
    <TouchableOpacity
      key={notification.id}
      style={[styles.notificationItem, !notification.is_read && styles.unreadNotificationItem]}
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalBody}>
              <Text style={styles.modalTimestamp}>{selectedNotification?.created_at}</Text>
